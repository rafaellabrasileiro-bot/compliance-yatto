...
MAPEAMENTO_CNAE_DETALHADO = {
    "4930-2/01": "Transporte rodoviário de cargas não perigosas",
    "4930-2/02": "Transporte rodoviário de cargas não perigosas (intermunicipal/interestadual)",
    "4930-2/03": "Transporte rodoviário de produtos e resíduos perigosos",
    ...
    "3831-9/99": "Recuperação de materiais metálicos diversos",
    "3839-4/99": "Recuperação de materiais não especificados",
    "3839-4/01": "Compostagem / tratamento de resíduos orgânicos",
    "3900-5/00": "Descontaminação e serviços de gestão de resíduos",
    "4687-7/01": "Comércio atacadista de resíduos de papel e papelão",
    "4687-7/02": "Comércio atacadista de resíduos plásticos",
    "4687-7/03": "Comércio atacadista de resíduos metálicos e sucatas",
    "5211-7/01": "Armazéns gerais",
    "5211-7/99": "Depósitos de mercadorias para terceiros / armazenagem",
    "5250-8/03": "Agenciamento de cargas",
    "5250-8/04": "Organização logística do transporte de carga",
    "5250-8/05": "Operador de transporte multimodal - OTM",
    "5212-5/00": "Carga e descarga de mercadorias",
    "5229-0/99": "Atividades auxiliares dos transportes terrestres",
    "3701-1/00": "Esgotamento sanitário e serviços relacionados",
